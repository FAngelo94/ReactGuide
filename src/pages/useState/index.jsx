...
`} />
      ...
      <CollapseContainer
        ...
        children={
          <React.Fragment>
            ...
            <h5><a href="https://github.com/FAngelo94/ReactGuide/tree/main/src/pages/useState/femos/dimpleCase.jsx" className="link-primary" target="_blank">Caso Semplice</a></h5>
            <p>Esempio semplice con un contatore e 2 pulsanti che aggiornano lo stato aumentando o diminuendo la variabile di 1</p>
            <SimpleCase />

            <h5><a href="https://github.com/FAngelo94/ReactGuide/tree/main/src/pages/useState/demos/formCase.jsx" className="link-primary" target="_blank">Gestione di un Form con più campi</a></h5>
      ...
      <CollapseContainer
        ...
        children={
          <React.Fragment>
            <p>Clicca sul titolo di ciascun esempio per essere reindirizzato al codice su github</p>
            <h5><a href="https://github.com/FAngelo94/ReactGuide/tree/main/src/pages/useState/errors/multipleUpdates.jsx" className="link-primary" target="_blank">Aggiornamento multiplo</a></h5>
